  ...
  render() {
    return (
      <div>
        <h1>The Project</h1>
        <h3>Overview</h3>
        <p>We are excited to share a new, free, speech-language therapy app developed through the mutual efforts of Carnegie Mellon University students on the Design for America Team and a Pittsburgh-based speech-language pathologist, Alyse O. Baker, CCC-SLP.  The app was launched in April 2018. </p>
        <h3>Purpose</h3>
      ...
      <br/>
      <p>These types of tools are not the most efficient for several reasons. First, the foam board is too bulky and not easily transportable, which makes it inconvenient for students and parents who want to utilize the tool outside of class time. Second, even though the velcro used to change the order of the parts of speech allows students to create a variety of different sentences, the vocabulary blocks themselves are not customizable enough and don’t have a wide range of options. Because of these limiting aspects of the foam board, it was decided that an app would greatly improve this system, and greatly benefit the students’ learning.</p>
